    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#dfdfdf;">
        ...
        <footer id="footer">
            <div class="container-fluid text-center rounded bg-light p-2">
                ...
                <div class="credits">
                    Designed by <a href="https://bootstrapmade.com/"> Anto Richard.S</a>
                </div>
            </div>
        </footer>
    </div>
...
### Home Page:
![home](https://user-images.githubusercontent.com/93427208/153766200-976a6813-931b-4ec7-9ae8-b532a5cb67ed.png)

### Home Page Bottom:
![homeextn](homeextn.png)

### Home Page Extension:
![homeextn1](homeextn1.png)
